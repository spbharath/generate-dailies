...
class ImageBufAlgo:
    ...
    @overload
    @staticmethod
    def fit(dst: ImageBuf, src: ImageBuf, filtername: str = ..., filterwidth: float = ..., exact: bool = ..., roi: ROI = ..., nthreads: int = ...) -> bool: ...
    @overload
    @staticmethod
    def fit(src: ImageBuf, filtername: str = ..., filterwidth: float = ..., exact: bool = ..., roi: ROI = ..., nthreads: int = ...) -> ImageBuf: ...
    @overload
    @staticmethod
...
class ImageCache:
    ...
    def get_imagespec(self, filename: str, subimage: int = ..., miplevel: int = ..., native: bool = ...) -> ImageSpec: ...
...
class ImageInput:
    ...
    @overload
    def read_native_deep_scanlines(self, ybegin: int, yend: int, z: int, chbegin: int, chend: int) -> object: ...
    @overload
    ...
    @overload
    def read_native_deep_tiles(self, xbegin: int, xend: int, ybegin: int, yend: int, zbegin: int, zend: int, chbegin: int, chend: int) -> object: ...
